...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Beta6.1 AE refinement experiments.")
    parser.add_argument("--config", default="configs/01_main_beta6_1_ae_refine.yaml", help="Path to YAML config.")
...
def main() -> int:
    ...
    for raw_variant in config["autoencoder_variants"]:
        ...
        torch, network, best_epoch, ae_log = train_autoencoder_early_stop(x_ae_train, variant)
        ...
        torch_full, network_full = train_autoencoder_fixed_epochs(x_ae_full, variant, best_epoch)
